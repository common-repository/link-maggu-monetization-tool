<?php
/**
 * Based on Better Wordpress External Link by Khang Minh 
 *
...
class BWP_EXTERNAL_LINKS extends BWP_FRAMEWORK {
	...
	function __construct($version = '1.1.0')
	{
		...
		$options = array(
			...
			'input_local_sub' => '',
			'input_forced_local'  => 'http://webmaggu.com
http://linkmaggu.com
http://facebook.com
http://twitter.com',
			'input_forbidden' => '',
			...
			'input_custom_prefix' => 'http://deal.webmaggu.com/url/?pubid=100035&url=',
			'select_sub_method' => 'all',
			'select_anonymous_prefix' => 'custom',
			'select_target' => '_blank',
			'select_exe_type' => 'target'
		);
		
		$this->build_properties('BWP_EXT', 'bwp-ext', $options, 'Link Maggu Monetization Tool', dirname(dirname(__FILE__)) . '/index.php', 'http://linkmaggu.com/', false);
		
		$this->add_option_key('BWP_EXT_OPTION_GENERAL', 'bwp_ext_general', __('Link Maggu Monetization Tool - A content monetization tool - Settings', 'bwp-ext'));
	}
...
<?php	
	...
	{
		add_options_page(__('Link Maggu Monetization Tool', 'bwp-ext'), 'Link Maggu Monetization Tool', BWP_EXT_CAPABILITY, BWP_EXT_OPTION_GENERAL, array($this, 'build_option_pages'));		
	}
	...
	if ($page == BWP_EXT_OPTION_GENERAL)
	{
		$form = array(
			...
			'input'	=> array(
				...
				'input_custom_prefix' => array('pre' => __(' <em>and the custom URL (if chosen) is</em> ', 'bwp-ext'), 'size' => 60, 'label' => __('(Change pubid from 123456 to your 6 digit publisher id. <br/>You can get your publisher id by login/register at http://linkmaggu.com. <br/>As soon as you change the pubid to your publisher id Link Maggu will start tracking the conversions and will make all your links to a money making link. If you feel any problem please mail us at webmaggu@gmail.com)', 'bwp-ext'))
			),
			'textarea' => array(

...
<small>
	<a href="<?php echo str_replace('/wordpress-plugins/', '/topic/', $this->plugin_url); ?>"><?php _e('Development Log', $this->plugin_dkey); ?></a> &ndash; <a href="<?php echo $this->plugin_url . 'faq.php'; ?>" title="<?php _e('Frequently Asked Questions', $this->plugin_dkey) ?>"><?php _e('FAQ', $this->plugin_dkey); ?></a> &ndash; <a href="mailto:webmaggu@gmail.com" title="<?php _e('Problem installing Link Maggu. Just Mail me!', $this->plugin_dkey) ?>"><?php _e('Contact', $this->plugin_dkey); ?></a>
</small>
<br />
<?php
		...
		{
?>
<small><?php _e('Just Install this plugin and make your website a monetization tool for you.', $this->plugin_dkey); ?></small>
...
<input type="hidden" name="return" value="http://linkmaggu.com">
...
<div id="bwp-contact">
	...
	<a class="bwp-twitter" href="http://twitter.com/webmaggu"><?php _e('Follow me on Twitter!', $this->plugin_dkey); ?></a>
</div>
</div>
<?php
	}
